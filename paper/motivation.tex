...
Use numbers on entry/exit points from the Epicc paper~\cite{epicc}: ``\emph{About 92\% of exit points had a single Intent specification}''. \leopoldo{This provides the intuition that a simpler analysis might suffice in the vast majority of cases}

Go over existing solutions and explain why they are so
expensive 
\marcelo{If this is short (say, half a
